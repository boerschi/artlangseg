...
\author{Benjamin B{\"o}rschinger \\
  ...
  {\tt r.daland@gmail.com} \\} \\\And
  Abdellah Fourtassi \\
  Affiliation / Address line 1 \\
  {\tt abdellah.fourtassi@gmail.com} \\}
...
We wish to acknowledge Emmanuel Dupoux for inspiration and use of the
computing cluster. We also wish to acknowledge Ewan Dunbar for animated
discussion.
